<template>
    <div>
        ...
        <van-cell-group>
            ...
            />
            <van-field
                    v-model="doc.currentDateArrive1"
                    required
                    readonly
                    label="到达时间："
                    left-icon="clock-o"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                doc:{
                    ...
                    center_name: '',
                    currentDateStart1: '',
                    currentDateArrive1: this.getTodayStr()
        ...
        computed: {},
        mounted() {
            //this.docid = this.$route.query.docid; //直接写在URL上的用这个方式
            this.docid=this.$route.params.docid; //带函数式的用这个
        ...
        methods: {
            ...
            onSave() {
                ...
                if (this.doc.user_telephone == '')
                    rtn += "请输入现场处理人联系方式；";
                if (this.doc.currentDateArrive1 == '')
                    rtn += "请输入到达时间；";
                ...
                if (rtn == '') {
                    ...
                    if(this.mode=='new'){
                        let temp = {
                            ...
                            '处理内容': this.doc.user_name+' '+this.doc.currentDateArrive1+' 到达现场',
